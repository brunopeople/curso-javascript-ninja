( function( win, doc ) {
  ...
  */
  var pessoa1 = {
    name: 'Pâmela',
    lastname: 'Alves de Araújo'
  };

  var pessoa2 = {
    name: 'Leandro',
    lastname: 'Manoel da Silva'
  };
  ...
  */
  function sum() {
    ...
    return Array.prototype.reduce.call( arguments, function( acc, curr, index ){
  ...
  */
  ...
  console.log( sum( 3, 54, 23, 6, 9 ) );
  console.log( sum( 31, 154, 3 ) );
  console.log( sum( 31, 154, 3, 16, 29, 3, 4, 9 ) );
