( function() {
  ...
  */
  ...
  var sudoeste = [ 'São Paulo', 'Rio de Janeiro', 'Minas Gerais', 'Espírito Santo' ];
  ...
  */
  ...
  var brasil = sul.concat( sudoeste );
  ...
  */
  ...
  brasil.unshift( 'Amazonas', 'Acre', 'Roraima' );
  ...
  */
  var nordeste = [ 'Bahia', 'Sergipe', 'Alagoas', 'Pernambuco', 'Paraíba', 'Rio Grande do Norte', 'Ceará', 'Píaui', 'Maranhão' ];
