(function(){
  ...
  */
  var subtraction = calculator( 23, 18 );
  var multiplication = calculator( 23, 18 );
  var division = calculator( 17, 13 );
  var subtraction = calculator( 7, 38 );
  var mod = calculator( 9, 3 );
